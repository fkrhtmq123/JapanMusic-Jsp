...
<main class="index">
    <section class="slider">
        <ul>
            <li>
                <a href="#">
                    <img src="/music/img/violin_image.jpg" alt="">
                </a>
            </li>
            <li>
                <a href="#">
                    <img src="/music/img/viola_image.jpg" alt="">
                </a>
            </li>
            <li>
                <a href="#">
                    <img src="/music/img/cello_image.jpg" alt="">
                </a>
            </li>
        </ul>
    </section>
    <section class="content">
        <div class="string_instrument">
            ...
            <img src="/music/img/violin_banner.png" alt="">
        </div>
        <div class="banner">
            <div>
                <ul>
